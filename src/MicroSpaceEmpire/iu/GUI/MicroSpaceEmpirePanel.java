...
public class MicroSpaceEmpirePanel extends JPanel implements Observer, Constants {
    ...
    public void update(Observable ob, Object arg) {
        if (this.ob.getEstado() instanceof Fim) {
            JOptionPane.showMessageDialog(MicroSpaceEmpirePanel.this, this.ob.getVictoryPoints());
            this.ob.setMaquinaDeEstados(new MaquinaDeEstados());
            repaint();
            validate();
        }
    }
